...
// Calculando a média de um número

var media = function media() {
  for (var _len = arguments.length, numbers = new Array(_len), _key = 0; _key < _len; _key++) {
    numbers[_key] = arguments[_key];
  }
  var sum = numbers.reduce(function (numerosIterados1, numerosIterados2) {
    return numerosIterados1 + numerosIterados2;
  }, 0);
  return sum / numbers.length;
};
console.log("M\xE9dia aritim\xE9tica simples: ".concat(media(3, 6, 10, 9)));
